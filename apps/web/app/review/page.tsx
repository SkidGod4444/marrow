...
export const metadata = { title: "Review", description: "Recall prompts for the expressions you chose to learn." };
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <header className="space-y-1">
        ...
        <h1 className="reading text-[28px] font-semibold tracking-tight">Review</h1>
